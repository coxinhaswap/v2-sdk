...
export const FACTORY_ADDRESS_25 = '0xd590cC180601AEcD6eeADD9B7f2B7611519544f4' // M
...
export const INIT_CODE_HASH_25 = '0x7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf' // M
...
export const getFactoryAddress = (chainId: number) => {
    switch (chainId) {
        ...
        default:
             throw Error('Coxinha SDK: getFactoryaddress: Invalid chainId')
    }
}
...
export const getInitCodeHash = (chainId: number) => {
    switch (chainId) {
        ...
        default:
             throw Error('Coxinha SDK: getInitCodeHash: Invalid chainId')
    }
}
